...
In real-world, business repositories, it is unlikely that the sender and receiver will remain the only collaborators. Further, external collaborator engagement or reactions may occur due to organizational or social norms. Such events are out-of-scope conditions for the routing model.
